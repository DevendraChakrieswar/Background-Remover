...
const Menubar = () => {
    ...
    return(
        <nav className="fixed top-0 left-0 w-full z-50 bg-white/30 backdrop-blur-lg shadow-lg border-b border-white/30 px-8 py-4 flex justify-between items-center">
            {/* Left side : logo + text */}
            ...
            <div className="hidden md:flex items-center space-x-4">
                <SignedOut>
                    <button className="text-gray-700 hover:text-blue-500 font-medium hover:cursor-pointer"
                    onClick={openLogin}>
                        Login
                    </button>
                    <button className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium px-4 py-2 rounded-full transition-all hover:cursor-pointer"
            ...
            {menuOpen && (
                <div className="absolute top-16 right-8 bg-white shadow-md rounded-md flex flex-col space-y-4 p-4 w-40">
                    <SignedOut>
                        ...
                        <button className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium px-4 py-4 rounded-full text-center"
                        onClick={openRegister}>
                            Sign up
                        </button>
                    </SignedOut>
